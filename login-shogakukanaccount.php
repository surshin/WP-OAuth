...
$_SESSION['WPOA']['PROVIDER'] = 'Shogakukan Account';
define('HTTP_UTIL', get_option('wpoa_http_util'));
define('CLIENT_ENABLED', get_option('wpoa_shoacc_api_enabled'));
define('CLIENT_ID', get_option('wpoa_shoacc_api_id'));
define('CLIENT_SECRET', get_option('wpoa_shoacc_api_secret'));
define('REDIRECT_URI', rtrim(site_url(), '/') . '/');
define('SCOPE', ''); // PROVIDER SPECIFIC: Battle.net states that an empty scope will give us the user account ID
define('URL_AUTH', "http://dev-oauth.jobs/oauth/authorize?");
define('URL_TOKEN', "http://dev-oauth.jobs/oauth/access_token?");
define('URL_USER', "http://dev-oauth.jobs/users/me?");
